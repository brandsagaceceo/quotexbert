        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full bg-gray-50 border border-gray-300 rounded-lg p-4 text-gray-900 placeholder-gray-500 min-h-[120px] resize-y focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200"
            />
