...
export default function NotificationBell() {
  ...
  const getNotificationActionUrl = (notification: Notification) => {
    ...
    if (payload.threadId) return `/messages?threadId=${payload.threadId}${contractorSuffix}`;
    if (payload.conversationId) return `/messages?conversationId=${payload.conversationId}${contractorSuffix}`;
    if (payload.leadId) return `/messages?leadId=${payload.leadId}${contractorSuffix}`;
