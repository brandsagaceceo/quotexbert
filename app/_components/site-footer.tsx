      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-100">
          <div className="flex justify-center items-center gap-6 mb-6">
            <a
              href="https://www.facebook.com/quotexbert"
              target="_blank"
              rel="noopener noreferrer"
              className="text-ink-600 hover:text-rose-600 transition-colors duration-200"
              aria-label="Facebook"
            >
            ...
            <a
              href="https://www.instagram.com/quotexbert"
              target="_blank"
              rel="noopener noreferrer"
              className="text-ink-600 hover:text-rose-600 transition-colors duration-200"
            ...
            <a
              href="https://www.linkedin.com/company/quotexbert"
              target="_blank"
              rel="noopener noreferrer"
              className="text-ink-600 hover:text-rose-600 transition-colors duration-200"
              aria-label="LinkedIn"
