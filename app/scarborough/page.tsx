...
export const metadata: Metadata = {
  title: "Home Renovation Quotes Scarborough | Instant AI Estimates",
  description: "Get instant AI-powered renovation quotes for Scarborough homes. Kitchen, bathroom, basement renovations & more. Connect with verified local contractors. Free estimates in minutes.",
  keywords: [
    "Scarborough renovation quotes",
    "Scarborough contractors",
    "home renovation Scarborough",
    "Scarborough kitchen renovation",
    "Scarborough bathroom renovation",
    "basement finishing Scarborough",
    "renovation costs Scarborough",
    "contractors near me Scarborough"
  ],
  openGraph: {
    title: "Scarborough Home Renovation Quotes | QuoteXbert",
    description: "Instant AI-powered renovation estimates for Scarborough. Connect with verified local contractors. Free, fast, accurate.",
  },
};

export default function ScarboroughPage() {
  const neighborhoods = [
    "Agincourt", "Malvern", "Rouge", "West Hill", "Cliffside", 
    "Guildwood", "Wexford", "Birchcliff", "Bendale", "Woburn"
  ];

  const services = [
    { name: "Kitchen Renovation", price: "$15,000 - $45,000" },
    { name: "Bathroom Renovation", price: "$8,000 - $25,000" },
    { name: "Basement Finishing", price: "$25,000 - $60,000" },
    { name: "Flooring Installation", price: "$3,000 - $12,000" },
    { name: "Painting Services", price: "$2,500 - $8,000" },
    { name: "Deck Construction", price: "$8,000 - $20,000" },
  ];
      ...
      <div className="bg-gradient-to-r from-rose-600 to-orange-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-rose-200 font-semibold">Serving Scarborough & East Toronto</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Scarborough Home Renovation Quotes
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-rose-100">
            Get instant AI-powered renovation estimates for your Scarborough home. Connect with verified local contractors in minutes.
          </p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-rose-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
              ...
              Popular Services in Scarborough
            </h2>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-rose-200">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-rose-100 to-orange-100 rounded-lg">
              <p className="text-sm text-gray-800">
                <strong>Serving all of Scarborough</strong> including postal codes: M1B, M1C, M1E, M1G, M1H, M1J, M1K, M1L, M1M, M1N, M1P, M1R, M1S, M1T, M1V, M1W, M1X
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-rose-200 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Why Scarborough Homeowners Choose QuoteXbert
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Upload photos, get accurate Scarborough market pricing in 30 seconds</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-br from-rose-100 to-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Connect with licensed, insured contractors who specialize in Scarborough</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-br from-rose-100 to-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Based on actual 2026 Scarborough renovation costs and labor rates</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-rose-600 to-orange-600 rounded-2xl shadow-2xl p-8 md:p-12 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Start Your Scarborough Renovation?
          </h2>
          <p className="text-xl mb-8 text-rose-100">
            Join hundreds of satisfied Scarborough homeowners who got accurate estimates in minutes
          </p>
          <Link 
            href="/#instant-quote"
