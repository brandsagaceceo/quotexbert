      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="text-white">Instant home repair estimates.</span>
            <br />
            <span className="text-teal-400">No forms. No waiting.</span>
          </h1>

          <p className="text-xl text-neutral-400 mb-12 max-w-2xl mx-auto">
            Get AI-powered price estimates for your home repairs in seconds.
            Connect with qualified contractors in your area.
          </p>
