        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-ink-600 leading-relaxed max-w-3xl mx-auto mb-8">
              Connect with verified contractors in your area. Compare quotes,
              read reviews, and get your home improvement project started today.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-ink-600">
                Tell us about your home improvement project in just a few
                minutes
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600">
                We connect you with verified contractors in your area who
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600">
                Review quotes, check ratings, and choose the perfect contractor
                for your project
              </p>
            </div>
          </div>
