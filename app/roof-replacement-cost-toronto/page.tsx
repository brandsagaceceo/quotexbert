...
const reno = RENOVATION_TYPES['roof-replacement'];
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'new roof Toronto',
    'Toronto roofing price 2026',
    'GTA roof replacement cost',
    'asphalt shingles Toronto cost',
  ],
  openGraph: {
    title: reno.metaTitle,
    description: reno.metaDescription,
...
export default function RoofReplacementCostTorontoPage() {
  return (
