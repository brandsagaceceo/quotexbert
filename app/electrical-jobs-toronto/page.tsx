...
const rawData = tradeJobPages.find((p) => p.slug === "electrical-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/electrical-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/electrical-jobs-toronto",
      type: "website",
    },
  };
}
