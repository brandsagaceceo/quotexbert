...
const data = contractorCityPages.find((p) => p.slug === "where-to-find-contractor-leads-ontario")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      title: data.metaTitle,
      description: data.metaDescription,
      url: "https://www.quotexbert.com/where-to-find-contractor-leads-ontario",
      type: "website",
    },
  };
}
