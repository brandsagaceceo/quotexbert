            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-ink-600">
                  Get instant quotes for home improvement projects from trusted
          ...
          >
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-ink-600">
                  Connect with homeowners, manage leads, and grow your business
        ...
        {isLoading && (
          <div className="text-center mt-8">
            <div className="inline-flex items-center">
              <svg
                className="animate-spin -ml-1 mr-3 h-5 w-5 text-[var(--brand)]"
