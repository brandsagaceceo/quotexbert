...
const rawData = tradeJobPages.find((p) => p.slug === "roofing-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/roofing-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/roofing-jobs-toronto",
      type: "website",
    },
  };
}
