...
const n = TORONTO_NEIGHBORHOODS['east-york' as NeighborhoodSlug];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.quotexbert.com/contractors/east-york`,
    type: 'website',
    siteName: 'QuoteXbert',
  },
  alternates: { canonical: `https://www.quotexbert.com/contractors/east-york` },
};
...
export default function NeighborhoodPage() {
  return (
    <NeighborhoodContractorTemplate
      ...
      canonicalUrl="/contractors/east-york"
    />
  );
}
