...
const n = TORONTO_NEIGHBORHOODS['liberty-village' as NeighborhoodSlug];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.quotexbert.com/contractors/liberty-village`,
    type: 'website',
    siteName: 'QuoteXbert',
  },
  alternates: { canonical: `https://www.quotexbert.com/contractors/liberty-village` },
};
...
export default function NeighborhoodPage() {
  return (
    <NeighborhoodContractorTemplate
      ...
      canonicalUrl="/contractors/liberty-village"
    />
  );
}
