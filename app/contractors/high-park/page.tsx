...
const n = TORONTO_NEIGHBORHOODS['high-park' as NeighborhoodSlug];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.quotexbert.com/contractors/high-park`,
    type: 'website',
    siteName: 'QuoteXbert',
  },
  alternates: { canonical: `https://www.quotexbert.com/contractors/high-park` },
};
...
export default function NeighborhoodPage() {
  return (
    <NeighborhoodContractorTemplate
      ...
      canonicalUrl="/contractors/high-park"
    />
  );
}
