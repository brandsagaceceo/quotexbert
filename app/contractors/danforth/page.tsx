...
const n = TORONTO_NEIGHBORHOODS['danforth' as NeighborhoodSlug];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.quotexbert.com/contractors/danforth`,
    type: 'website',
    siteName: 'QuoteXbert',
  },
  alternates: { canonical: `https://www.quotexbert.com/contractors/danforth` },
};
...
export default function NeighborhoodPage() {
  return (
    <NeighborhoodContractorTemplate
      ...
      canonicalUrl="/contractors/danforth"
    />
  );
}
