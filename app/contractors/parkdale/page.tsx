...
const n = TORONTO_NEIGHBORHOODS['parkdale' as NeighborhoodSlug];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.quotexbert.com/contractors/parkdale`,
    type: 'website',
    siteName: 'QuoteXbert',
  },
  alternates: { canonical: `https://www.quotexbert.com/contractors/parkdale` },
};
...
export default function NeighborhoodPage() {
  return (
    <NeighborhoodContractorTemplate
      ...
      canonicalUrl="/contractors/parkdale"
    />
  );
}
