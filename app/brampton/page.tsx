...
export const metadata: Metadata = {
  title: "Home Renovation Quotes Brampton | Instant AI Estimates",
  description: "Get instant AI-powered renovation quotes for Brampton homes. Kitchen, bathroom, basement renovations & more. Connect with verified local contractors. Free estimates in minutes.",
  keywords: [
    "Brampton renovation quotes",
    "Brampton contractors",
    "home renovation Brampton",
    "Brampton kitchen renovation",
    "Brampton bathroom renovation",
    "basement finishing Brampton",
    "renovation costs Brampton",
    "contractors near me Brampton"
  ],
  openGraph: {
    title: "Brampton Home Renovation Quotes | QuoteXbert",
    description: "Instant AI-powered renovation estimates for Brampton. Connect with verified local contractors. Free, fast, accurate.",
  },
};

export default function BramptonPage() {
  const neighborhoods = [
    "Bramalea", "Heart Lake", "Springdale", "Northwood Park", "Sandalwood",
    "Creditview", "Queen Street Corridor", "Downtown Brampton", "Castlemore", "Snelgrove"
  ];

  const services = [
    { name: "Kitchen Renovation", price: "$15,000 - $45,000" },
    { name: "Bathroom Renovation", price: "$8,500 - $24,000" },
    { name: "Basement Finishing", price: "$24,000 - $58,000" },
    { name: "Flooring Installation", price: "$3,200 - $13,000" },
    { name: "Painting Services", price: "$2,600 - $8,500" },
    { name: "Deck Construction", price: "$8,500 - $20,000" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50">
      ...
      <div className="bg-gradient-to-r from-rose-600 to-orange-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-rose-200 font-semibold">Serving Brampton & Peel Region</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Brampton Home Renovation Quotes
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-rose-100">
            Get instant AI-powered renovation estimates for your Brampton home. Connect with verified local contractors in minutes.
          </p>
      ...
      <div className="bg-white border-b-2 border-rose-100 py-6">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className="text-3xl font-bold text-rose-600">650+</div>
            <div className="text-sm text-gray-600">Brampton Projects</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-rose-600">70+</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-rose-200">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-rose-100 to-orange-100 rounded-lg">
              <p className="text-sm text-gray-800">
                <strong>Serving all of Brampton</strong> including postal codes: L6P, L6R, L6S, L6T, L6V, L6W, L6X, L6Y, L6Z, L7A
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-rose-200 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Why Brampton Homeowners Choose QuoteXbert
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Upload photos, get accurate Brampton market pricing in 30 seconds</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-br from-rose-100 to-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Connect with licensed, insured contractors who specialize in Brampton</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-br from-rose-100 to-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Based on actual 2026 Brampton renovation costs and labor rates</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-rose-600 to-orange-600 rounded-2xl shadow-2xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-xl mb-8 text-rose-100">
            Join hundreds of satisfied Brampton homeowners who got accurate estimates in minutes
          </p>
          <Link 
            href="/#instant-quote"
