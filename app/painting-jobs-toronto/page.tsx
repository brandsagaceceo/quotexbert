...
const rawData = tradeJobPages.find((p) => p.slug === "painting-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/painting-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/painting-jobs-toronto",
      type: "website",
    },
  };
}
