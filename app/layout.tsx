      ...
      <head>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2513183642529279&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      ...
      >
        <ToastProvider>
          ...
          <main 
            ...
            style={{
              paddingBottom: 'calc(var(--bottom-nav-height, 56px) + env(safe-area-inset-bottom, 0px) + 8px)',
            }}
          >
            {children}
          </main>
