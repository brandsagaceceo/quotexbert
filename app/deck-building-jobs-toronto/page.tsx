...
const rawData = tradeJobPages.find((p) => p.slug === "deck-building-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/deck-building-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/deck-building-jobs-toronto",
      type: "website",
    },
  };
}
