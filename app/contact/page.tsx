        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">
              Get in Touch with <span className="bg-gradient-to-r from-red-800 to-teal-600 bg-clip-text text-transparent">QuotexBert Support</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="bg-white/80 backdrop-blur-sm border border-teal-200 rounded-xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-red-800 to-teal-600 bg-clip-text text-transparent mb-6">Send us a Message</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-300 rounded-lg px-4 py-3 text-slate-900 placeholder-slate-500 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full bg-white border border-slate-300 rounded-lg px-4 py-3 text-slate-900 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border border-slate-300 rounded-lg px-4 py-3 text-slate-900 placeholder-slate-500 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-red-800 to-teal-600 hover:from-red-900 hover:to-teal-700 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 rounded-lg font-medium transition-colors text-white"
                  >
            ...
            <div>
              <div className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl p-8 mb-8 shadow-lg">
                <h2 className="text-2xl font-bold bg-gradient-to-r from-red-800 to-teal-600 bg-clip-text text-transparent mb-6">Contact Information</h2>
              ...
              <div className="bg-gradient-to-r from-red-50 to-teal-50 border border-teal-200 rounded-xl p-6 shadow-lg">
                <h3 className="text-lg font-semibold bg-gradient-to-r from-red-800 to-teal-600 bg-clip-text text-transparent mb-3">Quick Help</h3>
                ...
                <div className="space-y-2">
                  ...
                  <a href="/contractor/jobs" className="block text-teal-700 hover:text-teal-800 transition-colors">
