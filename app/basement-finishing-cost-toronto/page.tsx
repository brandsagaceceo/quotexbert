...
const reno = RENOVATION_TYPES['basement-finishing'];
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Toronto basement finishing price',
    'legal basement suite Toronto cost',
    'GTA basement finishing cost 2026',
  ],
  openGraph: {
    title: reno.metaTitle,
    description: reno.metaDescription,
...
export default function BasementFinishingCostTorontoPage() {
  return (
