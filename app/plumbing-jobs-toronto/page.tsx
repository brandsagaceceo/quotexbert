...
const rawData = tradeJobPages.find((p) => p.slug === "plumbing-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/plumbing-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/plumbing-jobs-toronto",
      type: "website",
    },
  };
}
