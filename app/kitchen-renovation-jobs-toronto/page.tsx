...
const rawData = tradeJobPages.find((p) => p.slug === "kitchen-renovation-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/kitchen-renovation-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/kitchen-renovation-jobs-toronto",
      type: "website",
    },
  };
}
