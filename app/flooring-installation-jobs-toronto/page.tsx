...
const rawData = tradeJobPages.find((p) => p.slug === "flooring-installation-jobs-toronto")!;
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: { canonical: "https://www.quotexbert.com/flooring-installation-jobs-toronto" },
    openGraph: {
      title: rawData.metaTitle,
      description: rawData.metaDescription,
      url: "https://www.quotexbert.com/flooring-installation-jobs-toronto",
      type: "website",
    },
  };
}
